...
export const CATEGORIA_LABELS: Record<string, string> = {
  agro_industria_e_comercio: "Agro e Comércio",
  alimentos: "Alimentos",
  ...
  cine_foto: "Cinema e Fotografia",
  climatizacao: "Climatização",
  consoles_games: "Consoles e Games",
  construcao_ferramentas: "Ferramentas de Construção",
  construcao_iluminacao: "Iluminação",
  construcao_seguranca: "Construção e Segurança",
  ...
  industria_comercio_e_negocios: "Indústria e Negócios",
  ...
  moveis_cozinha_jantar_jardim: "Móveis de Cozinha e Jardim",
  moveis_colchao_e_estofado: "Colchões e Estofados",
  ...
  pet_shop: "Pet Shop",
  portateis_casa_forno_e_cafe: "Forno e Café",
  portateis_cozinha: "Portáteis de Cozinha",
  ...
  tablets_impressao_imagem: "Tablets e Fotografia",
  telefonia: "Telefonia",
  telefonia_fixa: "Telefonia Fixa",
  utilidades_domesticas: "Utilidades Domésticas",
};

export const CATEGORIA_IMAGENS: Record<string, string> = {
  perfumaria:
  ...
  telefonia_fixa:
    "https://upload.wikimedia.org/wikipedia/commons/c/cd/GOIP-4-telephony-integration.jpg",
  livros_interesse_geral:
    "https://upload.wikimedia.org/wikipedia/commons/c/c2/Paris_75005_Quai_de_Montebello_Bouquinistes_20071014.jpg",
  eletronicos:
  ...
  agro_industria_e_comercio:
    "https://upload.wikimedia.org/wikipedia/commons/0/0d/D%C3%BClmen%2C_Kirchspiel%2C_Erdbeerfeld_--_2015_--_6492-6.jpg",
  livros_importados:
    "https://upload.wikimedia.org/wikipedia/commons/2/23/Books_for_Free_-_20230302_095500.jpg",
  construcao_iluminacao:
    "https://upload.wikimedia.org/wikipedia/commons/8/8d/Construction_site_of_Riverside_South_%28Canary_Wharf%29_%28September_2007%29_%28night%29.jpg",
  bebidas:
    "https://upload.wikimedia.org/wikipedia/commons/5/57/Port_wine.jpg",
  eletrodomesticos_2:
    "https://upload.wikimedia.org/wikipedia/commons/5/5a/Coin-operated_washing_machines_in_Seven_Dials_Launderette_%26_Dry_Cleaners%2C_Brighton.jpg",
  eletroportateis:
    "https://upload.wikimedia.org/wikipedia/commons/c/c5/HK_WTS_%E8%81%AF%E5%90%88%E9%81%93_Junction_Road_%E6%A8%82%E5%AF%8C%E5%95%86%E5%A0%B4_Lok_Fu_Place_mall_shop_December_2020_SSG_40.jpg",
  industria_comercio_e_negocios:
    "https://upload.wikimedia.org/wikipedia/commons/a/ab/Final_assembly_2.jpg",
  dvds_blu_ray:
    "https://upload.wikimedia.org/wikipedia/commons/d/d4/HD-DVD_and_Blu-Ray_cases_%28crop%29.jpg",
  livros_tecnicos:
    "https://upload.wikimedia.org/wikipedia/commons/9/9c/Books_for_free_2023_20230302_095511.jpg",
  moveis_escritorio:
    "https://upload.wikimedia.org/wikipedia/commons/a/a0/Wikimedia_Deutschland_Office_2024-03-15_3.jpg",
  climatizacao:
    "https://upload.wikimedia.org/wikipedia/commons/e/e5/Army_and_Air_Force_Exchange_Services_%28AAFES%29_is_gearing_up_for_a_hot_summer_in_Germany_by_having_numerous_portable_air_conditioners_on_sale_at_their_main_store_at_Ramstein_Air_Base_and_the_%28U_S_Army_Garrison_Rheinland-Pfalz_6205789%29.jpg",
  instrumentos_musicais:
    "https://upload.wikimedia.org/wikipedia/commons/6/60/Cascio_Interstate_Music_SuperStore_Acoustic_Guitar_Cabin.jpeg",
  portateis_casa_forno_e_cafe:
    "https://upload.wikimedia.org/wikipedia/commons/a/a0/Coffee_machines.jpg",
  sinalizacao_e_seguranca:
    "https://upload.wikimedia.org/wikipedia/commons/e/e1/Letterboxes_Ocotillo_Wells_2013.jpg",
  artes:
    "https://upload.wikimedia.org/wikipedia/commons/f/fb/Painting_the_Grand_canyon.jpg",
  market_place:
    "https://upload.wikimedia.org/wikipedia/commons/b/b4/Supermarket_z_flagami_%28ubt%29.JPG",
  cine_foto:
    "https://upload.wikimedia.org/wikipedia/commons/a/aa/Camera-vivitar.png",
  alimentos_bebidas:
    "https://upload.wikimedia.org/wikipedia/commons/2/23/Supermarket_beer_display.jpg",
  flores:
    "https://upload.wikimedia.org/wikipedia/commons/6/67/JP_%E6%97%A5%E6%9C%AC_Japan_%E6%B2%96%E7%B9%A9_OKINAWA_Route_253_%E6%B5%A6%E8%A5%BF_Chome_AEON_Style_Department_Store_flowers_shop_yellow_n_pinkFebruary_2026_N13P_01.jpg",
  fashion_underwear_e_moda_praia:
    "https://upload.wikimedia.org/wikipedia/commons/3/36/Shayla_Zulcic_Portland.jpg",
  musica:
    "https://upload.wikimedia.org/wikipedia/commons/a/a0/Notes_pour_un_concerto_de_Mozart_%28manuscrit_autographe%29_-_btv1b10845299b_%281_of_8%29.jpg",
  audio:
    "https://upload.wikimedia.org/wikipedia/commons/f/f3/Audio_mixer_close_up.jpg",
  artes_e_artesanato:
    "https://upload.wikimedia.org/wikipedia/commons/0/04/Painter%27s_colors_pallet_%2846422320134%29.jpg",
  casa_conforto:
    "https://upload.wikimedia.org/wikipedia/commons/0/06/Bed_in_hotel_room_4.jpg",
  fashion_roupa_feminina:
    "https://upload.wikimedia.org/wikipedia/commons/4/4f/HK_TKO_%E5%B0%87%E8%BB%8D%E6%BE%B3_Tseung_Kwan_O_PopCorn_mall_shop_PIT_clothing_store_September_2021_SS2_03.jpg",
  fashion_roupa_infanto_juvenil:
    "https://upload.wikimedia.org/wikipedia/commons/1/1a/HK_TST_%E5%B0%96%E6%B2%99%E5%92%80_Tsim_Sha_Tsui_%E5%BD%8C%E6%95%A6%E9%81%93_132_Nathan_Road_%E7%BE%8E%E9%BA%97%E8%8F%AF%E5%95%86%E5%A0%B4_MiraPlace_shop_GU_Wear_Tokyo_Clothing_December_2020_SS2_06.jpg",
  la_cuisine:
    "https://upload.wikimedia.org/wikipedia/commons/7/7d/Inside_The_French_Laundry_Kitchen_%2811901702006%29.jpg",
  fashion_esporte:
    "https://upload.wikimedia.org/wikipedia/commons/f/f3/Sports_store_in_New_York_with_Novak_%C4%90okovi%C4%87_equipments.JPG",
  artigos_de_festas:
    "https://upload.wikimedia.org/wikipedia/commons/1/13/Party_hats_and_beer.jpg",
  moveis_colchao_e_estofado:
    "https://upload.wikimedia.org/wikipedia/commons/1/11/Sleepare_mattress_store%2C_New_York%2C_NY_02.jpg",
  portateis_cozinha:
    "https://upload.wikimedia.org/wikipedia/commons/f/f7/Fresh_fruits_and_a_blender_are_arranged_on_a_kitchen_counter_for_smoothie_preparation.jpg",
  pcs:
    "https://upload.wikimedia.org/wikipedia/commons/6/63/Laptop-2411303_960_720.jpg",
  cds_dvds_musicais:
    "https://upload.wikimedia.org/wikipedia/commons/7/7c/CD_Store_in_Bristol.jpg",
  tablets_impressao_imagem:
    "https://upload.wikimedia.org/wikipedia/commons/5/56/GDC_Online_2011_Monday_Smartphone_and_Tablet_Games_Summit.jpg",
};
